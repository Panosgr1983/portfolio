...
import { Menu, X, Code, PenTool, BarChart, ChevronRight, Mail, Instagram, Linkedin, Phone, MapPin, FileText, User, Briefcase, ExternalLink, ArrowRight, Send } from 'lucide-react';
